...
import { Bot, Loader2, MessageSquarePlus, PanelLeftClose, PanelLeftOpen, Send, Trash2, User } from "lucide-react";
    ...
    >
      <div
        className={cn(
          ...
          isOwner ? "bg-gradient-to-br from-blue-600 to-violet-600" : "bg-muted"
        )}
      >
        {isOwner ? <User className="h-4 w-4 text-white" /> : <Bot className="h-4 w-4 text-muted-foreground" />}
      </div>
